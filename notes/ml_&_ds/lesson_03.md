...
то есть у вас метрика будет фактически
...
просто количество вставок удалений и
...
наложить на другой пучок траектории и
...
x и у нас есть объекты обучающей выборке
