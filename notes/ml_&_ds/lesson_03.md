...
Дальше веса или степени важности соседей суммируются по всем объектам данного класса **y**, и объект **x** причисляется к тому классу **y**, для которого суммарная оценка близости $$Г_y(x)$$ максимальна. То есть сколько соседей было в окрестности объекта **x** каждого из классов - какой класс оказался в большинстве в этой окрестности, значит тому классу и надо относить **x** 
...
Только 1-ый сосед имеет вес $$w(i,x)=1$$ остальные все соседи просто не учитываются; то есть относи объект к тому классу, которому принадлежит его ближайший сосед
